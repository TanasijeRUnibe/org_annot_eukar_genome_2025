...
#SBATCH --output=/data/users/trakic/assembly_annotation_course/annotation/TE_dynamics/logs/TE_dynamics_%j.log
#SBATCH --error=/data/users/trakic/assembly_annotation_course/annotation/TE_dynamics/logs/TE_dynamics_%j.err

GENOME_PREFIX=asm.bp.p_ctg.fa.mod

EDTA_ANNO=/data/users/trakic/assembly_annotation_course/annotation/EDTA/asm.bp.p_ctg.fa.mod.EDTA.anno
