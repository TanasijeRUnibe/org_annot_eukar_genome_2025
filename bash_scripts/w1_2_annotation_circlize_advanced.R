...
gff_file <- "/data/users/trakic/assembly_annotation_course/organisation_annotation_eukaryotic_genomes/results3/EDTA_annotation/hifisam.asm.bp.p_ctg.fa.mod.EDTA.TEanno.gff3"
...
custom_ideogram <- read.table("/data/users/trakic/assembly_annotation_course/organisation_annotation_eukaryotic_genomes/results_week2/samtools/hifiasm_assembly.fai", header = FALSE, stringsAsFactors = FALSE)
...
pdf("/data/users/trakic/assembly_annotation_course/organisation_annotation_eukaryotic_genomes/03-TE_density_with_genes.pdf", width = 10, height = 10)
