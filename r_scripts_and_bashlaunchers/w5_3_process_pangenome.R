...
# 0) Inputs
# -----------------
wd <- "/data/users/trakic/assembly_annotation_course/organisation_annotation_eukaryotic_genomes/GENESPACE/genespace_WD" # set your working directory where the pangenome_matrix.rds is located
focal_genome <- "RRS10" # Your focal accession name
