...
cls_file <- "/data/users/trakic/assembly_annotation_course/organisation_annotation_eukaryotic_genomes/R_visualizations/hifisam.asm.bp.p_ctg.fa.mod.EDTA.all.rexdb.cls.tsv"
